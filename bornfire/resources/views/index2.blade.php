    ...
    <div class="header-menu">
        <div class="container">
            <div class="header-logo">
                <a href="index-2.html" class="logo"><img src="{{asset('assets/hohimages/hohlogo.png')}}" width="110px" alt="logo"></a>
            </div>
            <nav class="nav-menu">
                <ul class="nav-list">
                    <li class="dropdown">
...
<section class="s-crossfit-slider">
    <div class="crossfit-slider">
            ...
            <div class="crossfit-slider-effect effect-1">
                <div data-hover-only="true" class="scene">
                    <span class="scene-item" data-depth="0.2" style="background-image:
                        url({{asset('assets/hohimages/scene.jpg')}})"></span>
                </div>
            </div>
            <div class="crossfit-slider-effect effect-2">
                <div data-hover-only="true" class="scene">
                    <span class="scene-item" data-depth="0.4" style="background-image: url({{asset('assets/hohimages/hikers.jpg')}})"></span>
                </div>
            </div>
            <div class="crossfit-slide-bg" style="background-image: url({{asset('assets/hohimages/idanrehills.jpg')}});"></div>
            <div class="container">
        ...
        <div class="crossfit-slide">
            <div class="crossfit-slider-effect effect-1">
                <div data-hover-only="true" class="scene">
                    <span class="scene-item" data-depth="0.2" style="background-image: url({{asset('assets/hohimages/idanrehils.jpg')}});"></span>
                </div>
            </div>
            <div class="crossfit-slider-effect effect-2">
                <div data-hover-only="true" class="scene">
                    <span class="scene-item" data-depth="0.4" style="background-image: url({{asset('assets/hohimages/smilegirls.jpg')}});"></span>
                </div>
            </div>
            <div class="crossfit-slide-bg" style="background-image: url({{asset('assets/hohimages/sunrays.jpg')}});"></div>
            <div class="container">
                <div class="crossfit-slide-cover">
                    <h2 class="title">push <span>yourself</span></h2>
        ...
        <div class="crossfit-slide">
            <div class="crossfit-slider-effect effect-1">
                <div data-hover-only="true" class="scene">
                    <span class="scene-item" data-depth="0.2" style="background-image: url({{asset('assets/hohimages/hikers.jpg')}});">
            ...
            <div class="crossfit-slider-effect effect-2">
                <div data-hover-only="true" class="scene">
                    <span class="scene-item" data-depth="0.4" style="background-image: url({{asset('assets/hohimages/yellow.jpg')}});"></span>
                </div>
            </div>
            <div class="crossfit-slide-bg" style="background-image: url({{asset('assets/hohimages/yellow.jpg')}});"></div>
            <div class="container">
                <div class="crossfit-slide-cover">
                    <h2 class="title">push <span>yourself</span></h2>
...
<!-- ============== S-OUR-PROGRAMS ============== -->
<section class="s-our-programs" style="background-image: url({{asset('assets/hohimages/idanrehills.jpg')}});">
    <div class="mask"></div>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3 program-col">
                <div class="program-item">
                    <div class="program-item-front" style="background-image: url({{asset('assets/hohimages/workout.jpg')}})">
                        <div class="program-item-inner">
                            <h3>WORK OUT</h3>
                        </div>
                    </div>
                    <div class="program-item-back" style="background-image:  url({{asset('assets/hohimages/smilegirls.jpg')}})">
                        <div class="program-item-inner">
                            <h3>THRILLS</h3>
            ...
            <div class="col-sm-6 col-md-3 program-col">
                <div class="program-item">
                    <div class="program-item-front" style="background-image: url({{asset('assets/hohimages/Alltitude.jpg')}}) ">
                        <div class="program-item-inner">
                            <h3>SCENERY</h3>
                        </div>
                    </div>
                    <div class="program-item-back" style="background-image:  url({{asset('assets/hohimages/scene.jpg')}})">
                        <div class="program-item-inner">
                            <h3>AMBIENCE</h3>
            ...
            <div class="col-sm-6 col-md-3 program-col">
                <div class="program-item">
                    <div class="program-item-front" style="background-image:  url({{asset('assets/hohimages/games1.jpg')}})">
                        <div class="program-item-inner">
                            <h3>GAMES</h3>
                        </div>
                    </div>
                    <div class="program-item-back" style="background-image:url({{asset('assets/hohimages/team2.jpg')}}) ">
                        <div class="program-item-inner">
                            <h3>SPORTS</h3>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-3 program-col">
                <div class="program-item">
                    <div class="program-item-front" style="background-image:url({{asset('assets/hohimages/yellow.jpg')}})">
                        <div class="program-item-inner">
                            <h3>ALTTITUDES</h3>
                        </div>
                    </div>
                    <div class="program-item-back" style="background-image: url({{asset('assets/hohimages/climb.jpg')}})">
                        <div class="program-item-inner">
                            <h3>HEIGHTS</h3>
...
<section class="s-crossfit-banner">
    <div class="crossfit-banner-left" style="background-image: url({{asset('assets/hohimages/sunboy.jpg')}});"></div>
        ...
        <div class="row-gallery">
            <div class="grid-gallery">
                ...
                <div class="gallery-item">
                    <a href="{{asset('assets/hohimages/awele.jpg')}}" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/awele.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="{{asset('assets/hohimages/team2.jpg')}}"  data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/team2.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="{{asset('assets/hohimages/team.jpg')}}"  data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/team.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/games1.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/games1.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/backs.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/backs.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/climb.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/climb.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/smilegirls.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/smilegirls.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/yellow.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/djsanti.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/yellow.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/awelefrnd.jpg')}}" alt="img">
                        <div class="gal-item">
                ...
                <div class="gallery-item">
                    <a href="assets/hohimages/soldiers.jpg" data-fancybox="gallery1">
                        <img src="{{asset('assets/hohimages/soldiers.jpg')}}" alt="img">
                        <div class="gal-item">
...
<!-- ============== S-TESTIMONIALS ============== -->
<section class="s-testimonials" style="background-image: url({{asset('assets/hohimages/djsanti.jpg')}});">
    <div class="mask"></div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 footer-item-logo">
                <a href="index-2.html" class="logo-footer"><img src="{{asset('assets/hohimages/hohlogo.png')}}" width="110px"alt="logo"></a>
