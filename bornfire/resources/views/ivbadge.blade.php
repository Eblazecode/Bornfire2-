...
<head>
    ...
    <script src="{{asset('assets/js/styles.js')}}" type="text/javascript"></script>
    <style>
        h1{color: black;
...
<!--<body onload="load()">-->
<body style="background-image: url({{asset('assets/hohimages/bornfire.jpg')}}); background-size: cover;">
...
<div class="container">
    <div class="left">
        ...
        <img src="{{asset('assets/hohimages/yellow.png')}}" alt="" id="arrow">
    </div>


    <div class="right">
        <div id="badge">
            <img src="{{asset('assets/hohimages/attending.jpg')}}" id="voltage-badge" alt="Personalized IV" width="520" height="480">
...
<script src="{{asset('assets/js/html2canvas.min.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/js/FileSaver.js')}}" type="text/javascript"></script>
